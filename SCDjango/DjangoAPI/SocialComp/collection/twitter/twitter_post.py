...
class TwitterPost:
    ...
    def scrape_post(self):
        ...
        #@NOTE(P): These classes seem to change periodically, breaking the code. May be a better way to find this info.
        ...
        if post_url is not None:
            self.post_url = "https://www.twitter.com" + post_url['href']
        else:
